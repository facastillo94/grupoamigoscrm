					...
					<div class="header-top-menu tabl-d-n">
						<ul class="nav navbar-nav mai-top-nav">
							...
							<?php
								...
								if($usuario['tpc_rol_usuario'] == -1){//SI ES ALIADO ESTRATEGICO
									echo '
									<li class="nav-item"><a href="banners.php?opc=principal" class="nav-link">Banners Principales</a>
									</li>';
									echo '
									<li class="nav-item"><a href="banners.php?opc=secundario" class="nav-link">Banners Secundarios</a>
									</li>';
								}else{
									if($usuario['tpc_rol_usuario'] == 2){//SI ES ADMIN
										echo '
										<li class="nav-item"><a href="filtros.php?opcion=usuarios" class="nav-link">Usuarios</a>
										</li>';
									}
									echo '<li class="nav-item"><a href="filtros.php?opcion=contactos" class="nav-link">Establec.</a>
									</li>';
									...
									/*echo '<li class="nav-item"><a href="filtros.php?opcion=ayuda" class="nav-link">Tutoriales</a>
									</li>';*/
								}
							?>
						</ul>
						...
						<ul class="nav navbar-nav mai-top-nav header-right-menu">
							...
							<li class="nav-item">
								<a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
									...
									<span class="admin-name"><?php echo $tpc_nombres_usuario_menu[0] . ' ' . $tpc_apellidos_usuario_menu[0]; ?></span>
								...
								<ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
									...
									<li><a href="cambiar_clave.php"><span class="adminpro-icon adminpro-settings author-log-ic"></span>Cambiar Clave</a>
									</li>
									<li><a href="cerrar_sesion.php"><span class="adminpro-icon adminpro-locked author-log-ic"></span>Cerrar Sesión</a>
									</li>
								</ul>
							</li>
