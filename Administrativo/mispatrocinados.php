<?php
	...
	if($usuario['tpc_rol_usuario'] != -1 && $usuario['tpc_rol_usuario'] != -2 && $usuario['tpc_rol_usuario'] != -3){//SI NO ES ADMIN
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Mis patrocinados</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div id="inbox" class="tab-pane fade in animated zoomInDown custom-inbox-message shadow-reset active">
                                            ...
                                            <a href="gestContenido.php?opc=nuevo&tipo=contacto" class="btn btn-primary btn-sm" style="background-color: #FF00FF;width:150px;"><font color="white">+ Crear Establecimiento</font></a>
												...
												<h2>Mis patrocinados</h2>
                                                <div class="view-mail-action view-mail-ov-d-n">
                                                    <a href="mispatrocinados.php"><i class="fa fa-reply"></i> Recargar</a>
                                                ...
                                                <form name="reportecontactos" id="reportecontactos" method="post" action="gestContenido.php">
                                                    ...
                                                    <table style="width:100%" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar1">
                                                        ...
                                                        <?php
                                                            ...
                                                            $cadena = "SELECT * FROM tp_establecimientos INNER JOIN tp_usuarios ON tpc_asignadoa_establecimiento=tpc_codigo_usuario AND tpc_asignadoa_establecimiento='".$mkid."' ".$adicional." ORDER BY tpc_nombre_establecimiento;";
                                                            $con->query($cadena);
                                                            if($con->num_rows() > 0){
                                                                ...
                                                                <tbody>';
                                                                    while($con->next_record()){
                                                                        ...
                                                                        if($con->f("tpc_imagen_establecimiento") != ''){
                                                                            $imagen = '<img src="https://guiakmymedio.com.co/grupoamigoscrm/Administrativo/'.$con->f("tpc_imagen_establecimiento").'" height="60px" width="60px">';
                                                                        }
                                                                        echo '<tr>
                                                                        <td><center><input type="checkbox" id="check'.$contador.'" name="check'.$contador.'" value="'.$con->f("tpc_codigo_establecimiento").'"></center></td>
                                                                            ...
                                                                            <td><center><label><a href="'.$con->f("tpc_sitioweb_establecimiento").'">'.$con->f("tpc_sitioweb_establecimiento").'</a></label></center></td>
